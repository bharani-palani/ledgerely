    ...
    $query = $this->db->query(
      '
            SELECT * from (
                ...
                FROM income_expense_category WHERE inc_exp_cat_name LIKE "%' .
        $search .
        '%" AND inc_exp_cat_appId = "' .
        $appId .
        '" GROUP BY name LIMIT ' .
        $limit .
        '
                ...
                (SELECT 
                    ...
                    bank_appId as appId
                FROM banks WHERE bank_name LIKE "%' .
        $search .
        '%" AND bank_appId = "' .
        $appId .
        '" GROUP BY name LIMIT ' .
        ...
        '
                ...
                FROM income_expense WHERE (inc_exp_name LIKE "%' .
        $search .
        ...
        '
                ...
                FROM credit_cards WHERE credit_card_name LIKE "%' .
        $search .
        '%" AND credit_card_appId = "' .
        $appId .
        '" GROUP BY name LIMIT ' .
        $limit .
        '
                ...
                (SELECT 
                    ...
                    cc_appId as appId
                FROM credit_card_transactions WHERE (cc_transaction LIKE "%' .
        $search .
        '%" OR cc_comments LIKE "%' .
        $search .
        '%") AND cc_appId = "' .
        ...
        '
                ...
                (SELECT 
                    ...
                    wb_appId as appId
                FROM workbook WHERE wb_name LIKE "%' .
        $search .
        '%" AND wb_appId = "' .
        $appId .
        '" GROUP BY name LIMIT ' .
