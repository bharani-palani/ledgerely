...
class home extends CI_Controller
{
  ...
  public function resetPassword()
  {
    ...
    if ($validateOtpTime) {
      ...
      if ($update) {
        ...
        $emailData["matter"] = ["<p></p>", $resetPassword . " is your new password.", "Please change them periodically.", "<p></p>"];
  ...
  public function sendUserInfo()
  {
    ...
    if (
      ...
      $selectedAccess = array_filter($accessLevels, function ($val) use ($post) {
