...
const VerticalBarChart = props => {
  ...
  const order = useMemo(() => sortBy(sortClause), [data, sortClause]);
  ...
  const x = useMemo(
    () =>
      d3
        ...
        .padding(padding),
    [marginLeft, width, marginRight, padding, order],
  );
  ...
  const xAxis = useMemo(() => d3.axisBottom(x).tickSizeOuter(0), [x]);
  ...
  const zoom = useMemo(
    ...
    [width, height, marginLeft, marginRight, x, xAxis],
  );
