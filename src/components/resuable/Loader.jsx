...
const Loader = ({ middle }) => {
  ...
  return (
    <div
      className={`bg-${userContext?.userData?.theme} ${middle ? "d-flex align-items-center w-100 vh-100 justify-content-center" : "text-center p-1"}`}
    >
      <svg width='75' height='100' viewBox='0 0 100 100' fill='none' xmlns='http://www.w3.org/2000/svg'>
        <path
        ...
        <path
          ...
          stroke='#C2D82E'
        />
        <path d='M19.6353 41.9859L48.2481 20.9727' stroke='#C2D82E' strokeWidth='2' strokeLinecap='round' />
        <path d='M24.9629 49.2398L53.5757 28.2266' stroke='#C2D82E' strokeWidth='2' strokeLinecap='round' />
        <g
          style={{
        ...
        >
          <circle fill='#C2D82E' stroke='#C2D82E' strokeWidth='2' r='2' cx='45' cy='60'>
            <animate
          ...
          <circle fill='#C2D82E' stroke='#C2D82E' strokeWidth='2' r='2' cx='55' cy='60'>
            <animate
              attributeName='opacity'
              calcMode='spline'
              dur='1.1'
          ...
          <circle fill='#C2D82E' stroke='#C2D82E' strokeWidth='2' r='2' cx='65' cy='60'>
            <animate
              attributeName='opacity'
              calcMode='spline'
              dur='1.1'
