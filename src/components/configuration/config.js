...
function Config(props) {
  ...
  const masterConfig = [
    ...
    },
    {
      ...
      label: intl.formatMessage({ id: 'facebookAppId' }),
      elementType: 'textArea',
      value: '',
      ...
      options: {
        ...
        help: [
          intl.formatMessage({ id: 'howToGetThem' }),
          intl.formatMessage({ id: 'goTo' }, { link: "https://developers.facebook.com/" }),
          intl.formatMessage({ id: 'signupAnAccountIfYouDontHaveOne' }),
          intl.formatMessage({ id: 'onceLoggedInYourAppIdWillBeVvailableOnTheTopHeader' }),
          intl.formatMessage({ id: 'dontForgetToToggleEnforceHttpsToYes' }),
          intl.formatMessage({ id: 'copyPasteHere' }),
          intl.formatMessage({ id: 'youAreDone' }),
          intl.formatMessage({ id: 'nowYouAllowPublicToLoginViaFacebookLogin' }),
        ],
      },
    },
    {
